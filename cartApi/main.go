...
import (
	...
	"github.com/xing-you-ji/go-container-micro/cartApi/handler"
...
func main() {
	...
	// 链路追踪
	t, io, err := common.NewTracer("go.micro.api.cartApi", "127.0.0.1:6831")
	if err != nil {
		log.Error(err)
	}
	defer io.Close()
	...
	cartService := cart.NewCartService("go.micro.service.cart",
		service.Client())
